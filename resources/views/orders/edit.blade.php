...
@section('content')
    ...
    <div class="row">
        <div class="col">
            <h1 class="fs-4">Редактирование заказа</h1>
        </div>
        <div class="col-auto">
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="order_date"
                                           value="{{$order->order_date ?? old('order_date') ?? null}}"
                                           class="{{$errors->has('order_date') ? 'form-control is-invalid' : 'form-control'}}"
                                           id="order_date">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="tel" name="phone" value="{{$order->phone ?? old('phone') ?? null}}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="email" name="email" value="{{$order->email ?? old('email') ?? null}}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="address"
                                           value="{{$order->address ?? old('address') ?? null}}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="coordinates"
                                           value="{{$order->coordinates ?? old('coordinates') ?? null}}"
                        ...
                        @foreach($order->products as $product)
                            <div class="mb-3 forappend" data-id="{{$loop->iteration}}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="count[]" min="1"
                                               value="{{$product->pivot->count ?? old('count') ?? 1}}"
                                               class="form-control count" data-count="{{$loop->iteration}}">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Стоимость</label>
                                        <input type="text" name="price[]"
                                               value="{{$product->pivot->sum ?? old('price') ?? null}}"
                                               class="form-control price" data-price="{{$product->price}}"
                                               data-sum="{{$loop->iteration}}" readonly>
                                    </div>
                                    <div class="mb-5 mt-2 text-end">
                                        <button class="btn btn-danger remove" data-id="{{$loop->iteration}}">Удалить
                                        </button>
                                    </div>
                                </div>
                            </div>
